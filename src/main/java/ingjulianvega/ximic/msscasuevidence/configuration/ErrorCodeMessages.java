...
public class ErrorCodeMessages {
    ...
    public static final String EVIDENCE_NOT_FOUND_API_CODE = "401";
    public static final String EVIDENCE_NOT_FOUND_ERROR = "EVIDENCE_NOT_FOUND";
    public static final String EVIDENCE_NOT_FOUND_MESSAGE = "No se encontró el antecedente";
    public static final String EVIDENCE_NOT_FOUND_SOLUTION = "Verifique los datos";
