...
import ingjulianvega.ximic.msscasuevidence.configuration.EvidenceParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(EvidenceParameters evidenceParameters) {
    ...
    public ResponseEntity<ApiError> validationErrorHandler(EvidenceException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(evidenceParameters.getApi())
